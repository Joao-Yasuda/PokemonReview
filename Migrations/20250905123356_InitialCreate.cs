        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FirstName = table.Column<string>(type: "NVARCHAR2(2000)", nullable: false),
                    LastName = table.Column<string>(type: "NVARCHAR2(2000)", nullable: false),
                    Gym = table.Column<string>(type: "NVARCHAR2(2000)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PokemonId = table.Column<int>(type: "NUMBER(10)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReviewerId = table.Column<int>(type: "NUMBER(10)", nullable: false),
                    PokemonId = table.Column<int>(type: "NUMBER(10)", nullable: false)
                },
                constraints: table =>
                {
